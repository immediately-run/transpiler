...
/**
 * Wrap Babel-transformed source in the HMR boundary prelude/postlude. The
 * prelude/postlude are pre-compressed to single lines so they don't perturb the
 * inline source map of `sourceCode`.
 */
